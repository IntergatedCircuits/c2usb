...
// also, wIndex == 8
constexpr usb::control::request_id SET_ALT_ENUM{direction::OUT, usb::control::request::type::VENDOR,
                                                usb::control::request::recipient::DEVICE,
                                                VENDOR_CODE};
} // namespace control
...
struct descriptor
{
    constexpr static uint16_t size() { return sizeof(T); }
...
/// @details The Microsoft OS 2.0 model ID descriptor is used to uniquely identify the physical
/// device.
