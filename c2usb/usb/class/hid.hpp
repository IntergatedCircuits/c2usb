...
namespace usb::hid
{
    ...
    {
        SET_REPORT   = 0x09, /// Send a report to the device, setting the state of input, output, or feature controls.
        ...
        SET_PROTOCOL = 0x0B, /// Sets the new protocol. wValue = @ref protocol
        GET_PROTOCOL = 0x03, /// Read which @ref USBD_HID_ProtocolType is currently active.
    };

    namespace control
    {
        constexpr usb::control::request_id SET_REPORT {
            direction::OUT, usb::control::request::type::CLASS, usb::control::request::recipient::INTERFACE,
            request::SET_REPORT };

        constexpr usb::control::request_id GET_REPORT {
            direction::IN, usb::control::request::type::CLASS, usb::control::request::recipient::INTERFACE,
            request::GET_REPORT };

        constexpr usb::control::request_id SET_IDLE {
            direction::OUT, usb::control::request::type::CLASS, usb::control::request::recipient::INTERFACE,
            request::SET_IDLE };

        constexpr usb::control::request_id GET_IDLE {
            direction::IN, usb::control::request::type::CLASS, usb::control::request::recipient::INTERFACE,
            request::GET_IDLE };

        constexpr usb::control::request_id SET_PROTOCOL {
            direction::OUT, usb::control::request::type::CLASS, usb::control::request::recipient::INTERFACE,
            request::SET_PROTOCOL };

        constexpr usb::control::request_id GET_PROTOCOL {
            direction::IN, usb::control::request::type::CLASS, usb::control::request::recipient::INTERFACE,
