...
namespace usb::standard
{
    ...
    namespace device
    {
        ...
        enum class status_type : uint8_t
        {
            ...
            PTM         = 0x01, /// Returns PTM (Precision Time Measurement) Status Request information (wLength == 4)
        };
        ...
        constexpr control::request_id GET_STATUS {
            direction::IN, control::request::type::STANDARD, control::request::recipient::DEVICE,
            request::GET_STATUS };

        constexpr control::request_id CLEAR_FEATURE {
            direction::OUT, control::request::type::STANDARD, control::request::recipient::DEVICE,
            request::CLEAR_FEATURE };

        constexpr control::request_id SET_FEATURE {
            direction::OUT, control::request::type::STANDARD, control::request::recipient::DEVICE,
            request::SET_FEATURE };

        constexpr control::request_id SET_ADDRESS {
            direction::OUT, control::request::type::STANDARD, control::request::recipient::DEVICE,
            request::SET_ADDRESS };

        constexpr control::request_id GET_DESCRIPTOR {
            direction::IN, control::request::type::STANDARD, control::request::recipient::DEVICE,
            request::GET_DESCRIPTOR };

        constexpr control::request_id SET_DESCRIPTOR {
            direction::OUT, control::request::type::STANDARD, control::request::recipient::DEVICE,
            request::SET_DESCRIPTOR };

        constexpr control::request_id GET_CONFIGURATION {
            direction::IN, control::request::type::STANDARD, control::request::recipient::DEVICE,
            request::GET_CONFIGURATION };

        constexpr control::request_id SET_CONFIGURATION {
            direction::OUT, control::request::type::STANDARD, control::request::recipient::DEVICE,
            request::SET_CONFIGURATION };

        constexpr control::request_id SET_ISOCH_DELAY {
            direction::OUT, control::request::type::STANDARD, control::request::recipient::DEVICE,
            request::SET_ISOCH_DELAY };

        constexpr control::request_id SET_SEL {
            direction::OUT, control::request::type::STANDARD, control::request::recipient::DEVICE,
            request::SET_SEL };

        constexpr control::request_id SET_FW_STATUS {
            direction::OUT, control::request::type::STANDARD, control::request::recipient::DEVICE,
            request::SET_FW_STATUS };

        constexpr control::request_id GET_FW_STATUS {
            direction::IN, control::request::type::STANDARD, control::request::recipient::DEVICE,
    ...
    namespace interface
    {
        ...
        constexpr control::request_id GET_STATUS {
            direction::IN, control::request::type::STANDARD, control::request::recipient::INTERFACE,
            request::GET_STATUS };

        constexpr control::request_id CLEAR_FEATURE {
            direction::OUT, control::request::type::STANDARD, control::request::recipient::INTERFACE,
            request::CLEAR_FEATURE };
        ...
        constexpr control::request_id GET_INTERFACE {
            direction::IN, control::request::type::STANDARD, control::request::recipient::INTERFACE,
            request::GET_INTERFACE };

        constexpr control::request_id SET_INTERFACE {
            direction::OUT, control::request::type::STANDARD, control::request::recipient::INTERFACE,
    ...
    namespace endpoint
    {
        ...
        constexpr control::request_id GET_STATUS {
            direction::IN, control::request::type::STANDARD, control::request::recipient::ENDPOINT,
            request::GET_STATUS };

        constexpr control::request_id CLEAR_FEATURE {
            direction::OUT, control::request::type::STANDARD, control::request::recipient::ENDPOINT,
            request::CLEAR_FEATURE };
        ...
        constexpr control::request_id SYNCH_FRAME {
            direction::IN, control::request::type::STANDARD, control::request::recipient::ENDPOINT,
            request::SYNCH_FRAME };
    }
}
